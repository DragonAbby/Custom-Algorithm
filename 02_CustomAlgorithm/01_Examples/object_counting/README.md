...
- 如果产品型号为ks968，则在ks968下的[person_counting](../../02_Demo/AlgorithmPackage/ks968/person_counting)算法包上修改。
- 如果产品型号为ks988，则在ks988下的[person_counting](../../02_Demo/AlgorithmPackage/ks988/person_counting)算法包上修改。
...
若[转换模型](../../../01_ModelTraining/01_Detection/Yolov5/README.md)的anchors不是通用anchors，需在args下增加anchors参数。
    ...
    infer_time: 60
    ```
![](../../../docs/assets/model_yaml_counting.png)
