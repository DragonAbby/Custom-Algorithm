...
- 如果产品型号为ks968，则在ks968下的[person_loitering](../../02_Demo/AlgorithmPackage/ks968/person_loitering)算法包上修改。
- 如果产品型号为ks988，则在ks988下的[person_loitering](../../02_Demo/AlgorithmPackage/ks988/person_loitering)算法包上修改。
...
- **算法名称修改**。修改为自己定义的算法名称，如：custom_loitering，若不修改，会覆盖已有算法文件。
