...
- 如果产品型号为ks968，则在ks968下的[person_loitering](./ks968/person_loitering)算法包上修改。
- 如果产品型号为ks988，则在ks988下的[person_loitering](./ks988/person_loitering)算法包上修改。
...
## 2. 算法逻辑
- 检测人体、人体跟踪；
- 根据保存的历史检测框与当前帧检测框的IOU，判定是否发生徘徊行为。
