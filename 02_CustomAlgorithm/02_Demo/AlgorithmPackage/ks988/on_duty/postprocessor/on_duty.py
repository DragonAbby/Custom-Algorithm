...
class Postprocessor(BasePostprocessor):
    ...
    def _process(self, result, filter_result):
        ...
        if self.min_threshold is None:
            self.min_threshold = self.reserved_args['min_threshold']
        if self.max_threshold is None:
            self.max_threshold = self.reserved_args['max_threshold']
        ...
        for polygon in polygons.values():
            ...
            if count < self.min_threshold or count > self.max_threshold:
                hit = True
